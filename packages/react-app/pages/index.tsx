        ...
        <section className={styles.firstSection}>
          <div className={styles.textContent}>
            ...
            <div className={styles.actions}>
              <button>Carbon footprint</button>
          ...
          <div className={styles.content}>
            <div className={styles.row}>
              ...
              <div className={styles.box}>
                ...
                <p>
                  A tecnologia Toucan, an infrastructure blockchain, provides a
                  secure and decentralized environment for asset tokenization.
                  Integration with the Celo network allows for the exchange and
                  transaction of carbon credit tokens within the Celo ecosystem,
                  leveraging its trusted and efficient infrastructure.
                </p>
              </div>
            </div>
            <div className={styles.row}>
